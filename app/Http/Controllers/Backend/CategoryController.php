   ...
   public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect("/backend/category")->with('message', 'A New Category has been added');
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect("/backend/category")->with('message', 'The Category has been updated');
    }
    ...
    public function destroy(Requests\CategoryDestroyRequest $request, $id)
    {
        ...
        return redirect("/backend/category")->with('message', 'The Category has been deleted');
    }
}
